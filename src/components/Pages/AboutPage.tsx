    ...
    <>
      <section className="max-w-7xl mx-auto mt-20 py-24 px-6 flex flex-col md:flex-row items-center md:items-start justify-between">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start">
          <h1 className="text-7xl md:text-8xl font-semibold text-gray-900 mb-10 leading-tight text-center md:text-left">
            About our
            <br />
            company
          </h1>
        ...
        <div className="flex-1 max-w-xl mt-10 md:mt-0 md:pl-12 flex items-center md:items-end">
          <p className="text-gray-500 text-lg text-center md:text-left md:self-end md:mt-40">
            ...
            Ornare neque sed in ultricies lacus neque arcu elit netus. At donec
            duis vitae in.
          </p>
        </div>
      </section>
      ...
      <div className="flex h-screen">
        ...
        <div className="w-[58%] bg-[#101418] relative">
          ...
          <div className="absolute left-12 top-1/2 transform -translate-y-1/2 max-w-lg">
            ...
            <p className="text-gray-400 text-base leading-relaxed mb-8 max-w-md">
              ...
              mauris pellentesque est ut lobortis. Risus adipiscing pharetra
              nisl ac urna. Proin enim viverra ullamcorper pulvinar nulla.
              Risus.
            </p>

            {/* Join us button */}
            <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-full font-medium transition-colors duration-200 flex items-center gap-2">
              Join us
              <svg
                width="16"
                height="16"
