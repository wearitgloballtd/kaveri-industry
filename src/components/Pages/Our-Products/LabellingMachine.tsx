...
const LabellingMachine: React.FC = () => {
  ...
  const features = [
    "Pinpoint Accuracy: Eliminates crooked or wrinkled labels for a flawless look.",
    "High-Speed Application: Keeps up with your production line without causing bottlenecks.",
    "Highly Adaptable: Easily adjusts for different container shapes and label sizes.",
    "Durable & Reliable: Built for continuous, trouble-free operation.",
  ];
  ...
  const applications = [
    ...
    "Any product requiring a sticker label",
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-red-600 h-[60vh] overflow-hidden">
        ...
        <img
          src="/Our-Products/Labelling Machine/Labeling Machines.jpg"
        ...
        <div className="absolute inset-0 flex items-center justify-start px-8 md:px-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
              Labelling <span className="text-red-100">Machine</span>
            </h1>
            <p className="text-lg md:text-xl text-red-50 mb-8">
              Apply labels with speed, precision, and consistency.
            </p>
          </div>
        </div>
      </div>
        ...
        <section className="py-16 bg-white rounded-xl mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-3xl font-bold text-gray-800 mb-2">1B+</div>
              <p className="text-gray-600 font-medium">Labels Applied</p>
            </div>
            <div>
              <div className="text-red-600 mb-3 flex justify-center">
                <Award className="w-8 h-8" />
              </div>
              <div className="text-3xl font-bold text-gray-800 mb-2">0.5mm</div>
              <p className="text-gray-600 font-medium">Placement Accuracy</p>
            </div>
            <div>
              <div className="text-red-600 mb-3 flex justify-center">
              ...
              <p className="text-gray-600 font-medium">Labels/Min Speed</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Give your product a professional and polished appearance with
                our high-performance Labelling Machines. A great product
                deserves a great label, and our machines apply them with speed,
                precision, and consistency. Whether you're labelling bottles,
                jars, cans, or other containers, we have a solution that fits.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                From simple wrap-around labels to complex front-and-back
                applications, our labelers ensure your branding is perfect on
                every single item.
              </p>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl shadow-xl">
                <img
                  src="/Our-Products/Labelling Machine/Professional Labelling Solutions.jpg"
                  alt="Labelling Machine"
          ...
          <div className="md:col-span-2">
                      ...
                      <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="p-3 border border-gray-300">
                              Customizable (e.g., 20-120mm Diameter)
                            </td>
                          </tr>
                          <tr>
                            <td className="p-3 border border-gray-300">
                            ...
                            <td className="p-3 border border-gray-300">
                              Customizable (e.g., 20-300mm Length)
                            </td>
                          </tr>
                          <tr>
                            <td className="p-3 border border-gray-300">
                            ...
                            <td className="p-3 border border-gray-300">
                              PLC with HMI, Stepper/Servo Motor
                            </td>
                          </tr>
                        </tbody>
                      </table>
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">
                Advanced Labelling Technology
              </h3>
              <p className="text-gray-600 mb-4">
                Our machines use state-of-the-art technology to ensure every
                label is applied perfectly, enhancing your brand's image.
              </p>
              <div
              ...
              >
                <p className="text-gray-600 mb-4">
                  Featuring high-precision sensors and robust applicators, our
                  labelers can handle a variety of label types and container
                  shapes. The system automatically synchronizes the conveyor,
                  container feeding, and label dispensing for seamless,
                  high-speed operation.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold mb-2">Applicator Types</h4>
                    <ul className="list-disc pl-5 text-gray-600">
                      <li>Wrap-around labelling</li>
                      <li>Front and back labelling</li>
                      <li>Top and bottom labelling</li>
                      <li>Tamper-evident labelling</li>
                    </ul>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold mb-2">Control & Automation</h4>
                    <ul className="list-disc pl-5 text-gray-600">
                      <li>Servo/Stepper motor control</li>
                      <li>Product and label sensors</li>
                      <li>Easy-to-use touchscreen interface</li>
                      <li>Batch coding integration</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="sticky top-24">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mb-6">
                ...
                <p className="text-gray-600 mb-6">
                  Contact our experts to discuss your labelling requirements and
                  ...
                  <li>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">For bag sealing</p>
                      </div>
                    </Link>
                  </li>
                </ul>
...
export default LabellingMachine;
