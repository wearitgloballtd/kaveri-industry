...
const BandSealer: React.FC = () => {
  ...
  const features = [
    "Consistent, High-Quality Seals: Ensures product freshness and security",
    "Adjustable Speed & Temperature: Works perfectly with materials like laminates, polypropylene, and more",
    "Versatile Orientation: Available in both horizontal and vertical models to suit your product",
    "Optional Printing: Can be equipped with an embosser or ink coder to print dates and batch codes",
    "Tamper-Proof Protection: Seals protect products from moisture and contaminants",
    "High-Volume Capability: Perfect solution for medium-to-high volume operations",
  ];
        ...
        <div className="absolute inset-0 flex items-center justify-start px-8 md:px-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
              Band <span className="text-red-100">Sealer</span>
            </h1>
            <p className="text-lg md:text-xl text-red-50 mb-8">
              Create strong, clean, and professional-looking seals on all your
              pre-made pouches
            </p>
          </div>
        </div>
        ...
        <section className="py-16 bg-white rounded-xl mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-600 font-medium">Packages Sealed</p>
            </div>
            <div>
              <div className="text-red-600 mb-3 flex justify-center">
            ...
            <div>
              ...
              <p className="text-gray-600 font-medium">Seal Success Rate</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Create strong, clean, and professional-looking seals on all your
                pre-made pouches with our dependable Band Sealer. This
                continuous sealing machine is the perfect solution for
                medium-to-high volume operations, offering a fast and reliable
                way to seal a wide variety of bag materials.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                It's the workhorse of any packaging line, ensuring your products
                are tamper-proof and protected from moisture and contaminants.
                Trusted by 500+ manufacturers worldwide with a 99.9% seal
                success rate.
              </p>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl shadow-xl">
                ...
                <div className="absolute top-4 right-4 bg-white rounded-xl p-4 shadow-lg">
                  ...
                  <div className="text-sm text-gray-600">m/min Speed</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Our Band Sealer incorporates cutting-edge technology to ensure
                consistent, professional-grade sealing for all your packaging
                needs.
              </p>
              <div
              ...
              >
                <p className="text-gray-600 mb-4">
                  The Band Sealer features advanced heating elements and
                  precision temperature control to deliver uniform seals across
                  different materials. With adjustable conveyor speeds and
                  customizable sealing parameters, it adapts to your specific
                  production requirements.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold mb-2">Sealing Capabilities</h4>
                    <ul className="list-disc pl-5 text-gray-600">
                      <li>Multi-layer film sealing</li>
                      <li>Heat-sealable laminates</li>
                      <li>Polypropylene and polyethylene</li>
                      <li>Foil and metallized films</li>
                    </ul>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="sticky top-24">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mb-6">
                ...
                <p className="text-gray-600 mb-6">
                  Contact our experts to discuss your specific sealing
